...
?>
<html>
<head><link rel="stylesheet" type="text/css" href="../biar_bagus.css"> <!-- link css -->
<title>Soal</title>	
	<style>
...
<div id="halaman" >
	...
	<div id="tengah_soal" ><p>&nbsp;</p><center><h2> Kumpulan Soal IPS </h2></center>
...
<?php
	 ...
	 $query="select * from soal_ips ORDER BY id";
	 $no = 1;

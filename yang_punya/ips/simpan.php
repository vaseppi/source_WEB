...
if (isset($_POST)) {	
	...
	$sql = "insert into soal_ips (pertanyaan, jawab_a, jawab_b, jawab_c, jawab_d, jawab_e, jawaban) values('$pertanyaan', '$jawab_a', '$jawab_b', '$jawab_c', '$jawab_d', '$jawab_e' ,'$jawaban')";
	...
	$sql = "UPDATE soal_ips SET image='$fileName' WHERE id=$id ";

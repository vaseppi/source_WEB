...
if (isset($_POST)) {	
	...
	$sql = "insert into soal_bahasa_inggris (pertanyaan, jawab_a, jawab_b, jawab_c, jawab_d, jawab_e, jawaban) values('$pertanyaan', '$jawab_a', '$jawab_b', '$jawab_c', '$jawab_d', '$jawab_e' ,'$jawaban')";
	...
	$sql = "UPDATE soal_bahasa_inggris SET image='$fileName' WHERE id=$id ";

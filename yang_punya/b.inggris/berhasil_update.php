...
//	$id =decrypt($_GET['id']); 	
    ...
    $sql = mysql_query("SELECT * FROM soal_bahasa_inggris WHERE id=$id") or die (mysql_error());
...
?> 
		...
		<table>
			<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $pertanyaan ?></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $jawab_a ?></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $jawab_b ?></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $jawab_c?></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $jawab_d ?></textarea>
				</td>
			</tr>
	...
	<!--		<tr>
				...
				<td>:</td>
				<td>
				<textarea rows="3" cols="40"><?php echo $jawab_e ?></textarea>
				</td>
			</tr> -->

...
if (isset($_POST)) {	
	...
	$sql = "insert into soal_seni_rupa (pertanyaan, jawab_a, jawab_b, jawab_c, jawab_d, jawab_e, jawaban) values('$pertanyaan', '$jawab_a', '$jawab_b', '$jawab_c', '$jawab_d', '$jawab_e' ,'$jawaban')";
	...
	$sql = "UPDATE soal_seni_rupa SET image='$fileName' WHERE id=$id ";

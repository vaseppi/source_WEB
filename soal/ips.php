...
<center>
	<table border="0" >
		...
		<td>
			...
			$data_soal = mysql_query("select * from soal_ips where id = '$id'");
			...
			$jumlah_soal = mysql_query("select count(*) from soal_ips");
			...
			echo "<center><span style='font-size:30px;'>Terimakasih telah mengerjakan Quiz IPS </br></br></center>";
			...
			// mari kita mulai
			$nmr = 0;
			$soal = mysql_query("select * from soal_ips ORDER BY RAND () "); //for random 
		//	$soal = mysql_query("select * from soal_ips");
			?>

			<form action="" method="post">
			<center><span style="font-size:22px;"><b>(SOAL - SOAL PEMBELAJARAN IPS)</b></p></p></center>
			<p>&nbsp;</p><p>&nbsp;</p>
			...
			<input type="hidden" name="matapelajaran" value="IPS" />
			</tr>
			</table>

...
<center>
	<table border="0" >
		...
		<td>
			...
			$data_soal = mysql_query("select * from soal_pkn where id = '$id'");
			...
			$jumlah_soal = mysql_query("select count(*) from soal_pkn");
			...
			echo "<center><span style='font-size:30px;'>Terimakasih telah mengerjakan Quiz Bahasa PKN </br></br></center>";
			...
			// mari kita mulai
			$nmr = 0;
			$soal = mysql_query("select * from soal_pkn ORDER BY RAND () "); //for random 
			//$soal = mysql_query("select * from soal_pkn");
			?>

			<form action="" method="post">
			<center><span style="font-size:22px;"><b>(SOAL - SOAL PEMBELAJARAN PKN)</b></p></p></center>
			<p>&nbsp;</p><p>&nbsp;</p>
			...
			<input type="hidden" name="matapelajaran" value="PKN" />
			</tr>
			</table>

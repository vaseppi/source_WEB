...
<center>
	<table border="0" >
		...
		<td>
			...
			$data_soal = mysql_query("select * from soal_bahasa_inggris where id = '$id'");
			...
			$jumlah_soal = mysql_query("select count(*) from soal_bahasa_inggris");
			...
			echo "<center><span style='font-size:30px;'>Terimakasih telah mengerjakan Quiz Bahasa Inggris </br></br></center>";
			...
			// mari kita mulai
			$nmr = 0;
			$soal = mysql_query("select * from soal_bahasa_inggris ORDER BY RAND () "); //for random 
			//$soal = mysql_query("select * from soal_bahasa_inggris");
			?>

			<form action="" method="post">
			<center><span style="font-size:22px;"><b>(SOAL - SOAL PEMBELAJARAN BAHASA INGGRIS)</b></p></p></center>
			<p>&nbsp;</p><p>&nbsp;</p>

			<table border="0" >
			<tr>
			<td width="5px"></td>
			<td><input type="text" name="nama_p" size="30" placeholder="Masukkan nama anda"   required ></td>
			<td width="200px"></td>
			<td><input type="email" name="email" size="30" placeholder="Masukkan email anda" required ></td>
			<input type="hidden" name="matapelajaran" value="B.Inggris" />
			</tr>
			</table>

...
<center>
	<table border="0" >
		...
		<td>
			...
			$data_soal = mysql_query("select * from soal_ipa where id = '$id'");
			...
			$jumlah_soal = mysql_query("select count(*) from soal_ipa");
			...
			echo "<center><span style='font-size:30px;'>Terimakasih telah mengerjakan Quiz IPA </br></br></center>";
			...
			// mari kita mulai
			$nmr = 0;
			$soal = mysql_query("select * from soal_ipa ORDER BY RAND () "); //for random 
			//$soal = mysql_query("select * from soal_ipa");
			?>

			<form action="" method="post">
			<center><span style="font-size:22px;"><b>(SOAL - SOAL PEMBELAJARAN IPA)</b></p></p></center>
			<p>&nbsp;</p><p>&nbsp;</p>
			...
			<input type="hidden" name="matapelajaran" value="IPA" />
			</tr>
			</table>


			<input type="hidden" name="tanggal" value="<?php echo $tgl ?>" size="30" /></br></br></p>
			<?php

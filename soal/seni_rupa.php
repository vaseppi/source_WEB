...
<center>
	<table border="0" >
		...
		<td>
			...
			$data_soal = mysql_query("select * from soal_seni_rupa where id = '$id'");
			...
			$jumlah_soal = mysql_query("select count(*) from soal_seni_rupa");
			...
			echo "<center><span style='font-size:30px;'>Terimakasih telah mengerjakan Quiz Seni Rupa </br></br></center>";
			...
			// mari kita mulai
			$nmr = 0;
			$soal = mysql_query("select * from soal_seni_rupa ORDER BY RAND () "); //for random 
			//$soal = mysql_query("select * from soal_seni_rupa");
			?>

			<form action="" method="post">
			<center><span style="font-size:22px;"><b>(SOAL - SOAL PEMBELAJARAN SENI RUPA)</b></p></p></center>
			<p>&nbsp;</p><p>&nbsp;</p>
			...
			<input type="hidden" name="matapelajaran" value="Seni Rupa" />
			</tr>
			</table>
